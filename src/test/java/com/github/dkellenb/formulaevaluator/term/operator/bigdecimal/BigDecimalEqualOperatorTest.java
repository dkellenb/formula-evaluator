...
/**
 * Tests for BigDecimalEqualOperator.
 */
public class BigDecimalEqualOperatorTest extends OperatorTest {

  @Test
  public void shouldPrintFormula() {
    // given
    Term<BigDecimal> operator = new BigDecimalEqualOperator(v("a"), v("b"));
  ...
  public void shouldCalculateWithNullFocused() {
    ...
    TermTester.testThat(createOp(v("a"), v("b"))).with(nullConfiguration).equalTo(ONE);
  ...
  private static Term<BigDecimal> createOp(Term<BigDecimal> base, Term<BigDecimal> applicant) {
    return new BigDecimalEqualOperator(base, applicant);
  }
